...
const test_service = async function () {
    ...
    try {
        ...
        //get descripton
        let descriptionMetamask = user0.walletDescriptions.filter((e) => e.type === "metamask")[0];
        ...
        let keepkeyWalletDescription = user1.walletDescriptions.filter((e) => e.type === "keepkey");
